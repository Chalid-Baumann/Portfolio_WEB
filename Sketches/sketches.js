document.addEventListener("DOMContentLoaded", function () {
    ...
    const imagesData = [
        ...
        { project: 'Project1', src: '/images/Sketches/VD_1_yes__Zeichenfläche 1 Kopie 4.png'},
        { project: 'Project1', src: '/images/Sketches/VD_1_yes__Zeichenfläche 1 Kopie 5.png'},
        { project: 'Project1', src: '/images/Sketches/VD_1_yes__Zeichenfläche 1 Kopie 6.png'},
        { project: 'Project1', src: '/images/Sketches/VD_1_yes__Zeichenfläche 1 Kopie 7.png'},
        ...
        { project: 'Project1', src: '/images/Sketches/VD_1_Blender_1.png'},
        { project: 'Project1', src: '/images/Sketches/VD_1_Blender_3.png'},
        { project: 'Project1', src: '/images/Sketches/VD_1_Blender_2.png'},
